...
public class GrievanceController {
    ...
    @GetMapping("/{id}")
    public UserGrievanceDTO getGrievanceById(@PathVariable long id) {
    ...
    public UserGrievanceDTO updateGrievanceStatusById(@PathVariable long id, @RequestBody StatusUpdateDTO status) {
        return this.grievanceService.updateGrievanceStatusById(id, status);
    }

    @DeleteMapping("/{id}")
    public void deleteGrievanceById(@PathVariable long id) {
