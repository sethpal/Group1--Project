...
public class CategoryService {
    ...
    public AdminCategoryDTO getAdminCategoryDTOById(long id) {
    ...
    public AdminCategoryDTO updateCategoryById(long id, AdminCategoryDTO category) {
    ...
    public List<UserCategoryDTO> getAllUserCategoriesByDepartmentId(long departmentId) {
    ...
    public Category saveCategoryByDepartmentId(long departmentId, Category category) {
        Department department = departmentService.getDepartmentById(departmentId);
        category.setDepartment(department);
        return categoryRepository.save(category);
    }

    public AdminCategoryDTO saveCategoryByDepartmentId(long departmentId, AdminCategoryDTO category) {
