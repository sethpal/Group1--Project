...
public class DepartmentService {
    ...
    public UserDepartmentDTO getUserDepartmentById(long id) {
    ...
    public AdminDepartmentDTO getAdminDepartmentById(long id) {
        Department department = departmentRepository.findById(id).orElse(null);
        if (department != null) {
    ...
    public AdminDepartmentDTO updateDepartmentById(long id, Department department) {
