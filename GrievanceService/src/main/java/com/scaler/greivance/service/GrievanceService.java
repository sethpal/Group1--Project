...
public class GrievanceService {
    ...
    public UserGrievanceDTO getGrievanceById(long id) {
    ...
    public Grievance updateGrievanceById(long id, Grievance grievance) {
...
//            grievanceToUpdate.setDepartment(grievance.getDepartment());
    ...
    public UserGrievanceDTO updateGrievanceStatusById(long id, StatusUpdateDTO statusUpdateDTO) {
        Grievance grievanceToUpdate = grievanceRepository.findById(id).orElse(null);
        if (grievanceToUpdate != null) {
    ...
    public List<Grievance> getAllGrievancesByCategoryId(long categoryId) {
